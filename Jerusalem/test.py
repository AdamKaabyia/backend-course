from Jerusalem import *
from Jerusalem.files_handeing import *
from Jerusalem.folder_handeling import *


def main():
    folder_path = r"C:\Users\akaab\PycharmProjects\backend-course\Jerusalem\recursion"
